...
data:
  ...
  bundledCode: "#line 1 \"remote_test/yosupo/math/inv_of_formal_power_series.1.test.cpp\"\
    ...
    #include <iterator>\n#line 9 \"remote_test/yosupo/math/inv_of_formal_power_series.1.test.cpp\"\
    \n\nint main() {\n#ifdef LOCAL\n  std::freopen(\"in\", \"r\", stdin), std::freopen(\"\
    out\", \"w\", stdout);\n#endif\n  std::ios::sync_with_stdio(false);\n  std::cin.tie(nullptr);\n\
    \  int n;\n  std::cin >> n;\n  using mint = lib::mm30<998244353>;\n  std::vector<mint>\
    \ a;\n  std::copy_n(std::istream_iterator<mint>(std::cin), n, std::back_inserter(a));\n\
    \  lib::semi_relaxed_convolution src(a, [iv = a.front().inv()](int n, const std::vector<mint>\
    \ &c) {\n    return n == 0 ? iv : -c[n] * iv;\n  });\n  std::copy_n(src.await(n).get_multiplier().begin(),\
